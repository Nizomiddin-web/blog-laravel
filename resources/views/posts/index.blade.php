<x-layouts.main>
    ...
    <x-pageheader>Blog sahifasi</x-pageheader>
    <div class="container-fluid py-5">
        <div class="container">
            <div class="row align-items-end mb-4">
                <div class="col-lg-6">
                    <h6 class="text-secondary font-weight-semi-bold text-uppercase mb-3">Oxirgi Blog</h6>
                    <h1 class="section-title mb-3">Oxirgi Bloglar</h1>
                </div>
                <div class="col-lg-6">
                    <h4 class="font-weight-normal text-muted mb-3">Nimadur yozish kerak</h4>
                </div>
            </div>
            <div class="row">
