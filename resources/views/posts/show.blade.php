                ...
                <div class="col-lg-8">
                    ...
                    <div class="mb-5">
                        <img class="img-fluid rounded w-100 mb-4" src="{{ asset('storage/' . $post->photo) }}"
                            alt="Image">
                        {{ $post->content }}
                        <h3 class="mb-4">salomlar</h3>
                        <img class="img-fluid rounded w-50 float-right ml-4 mb-3" src="/img/blog-2.jpg" alt="Image">
                    </div>

                    <div class="mb-5">
                        <h3 class="mb-4 section-title">{{ $post->comments->count() }} ta commentariya</h3>
                    ...
                    <div class="mb-5">
                        ...
                        @foreach ($recent_posts as $post1)
                            <div class="d-flex align-items-center border-bottom mb-3 pb-3">
                                <img class="img-fluid rounded" src="{{ asset('storage/' . $post1->photo) }}"
                                    style="width: 80px; height: 80px; object-fit: cover;" alt="">
                                <div class="d-flex flex-column pl-3">
                                    <a class="text-dark mb-2" href="">{{ $post1->short_content }}</a>
                                    <div class="d-flex">
